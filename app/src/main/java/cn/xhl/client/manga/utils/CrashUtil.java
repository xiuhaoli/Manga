...
public final class CrashUtil {
    ...
    static {
        try {
            PackageInfo pi = MyApplication.getAppContext().getPackageManager().getPackageInfo(MyApplication.getAppContext().getPackageName(), 0);
            if (pi != null) {
    ...
    public static void init(final String crashDir) {
        ...
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                && MyApplication.getAppContext().getExternalCacheDir() != null)
            defaultDir = MyApplication.getAppContext().getExternalCacheDir() + FILE_SEP + "crash" + FILE_SEP;
        else {
            defaultDir = MyApplication.getAppContext().getCacheDir() + FILE_SEP + "crash" + FILE_SEP;
        }
