...
public class RecommendFragment extends BaseFragment implements LatestContract.View ,BaseQuickAdapter.RequestLoadMoreListener, BaseQuickAdapter.OnItemClickListener{
    ...
    protected void initView(View view, Bundle savedInstanceState) {
        ...
        presenter.list(IConstants.NON_H, IConstants.RECOMMEND);
    }
